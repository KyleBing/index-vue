...
const projectList: Array<ProjectListGroupEntity> = [
    {
        ...
        isPublic: true,
        list: [
            {title: '标题日记', isPublic: true, description: '一个纯文本日记系统', path: 'https://github.com/KyleBing/diary'},
            ...
            {title: '玫枫跟打器', isPublic: true, description: '五笔跟打器', path: 'https://github.com/KyleBing/typepad'},
            {title: '路书系统', isPublic: true, description: '一个可以分享、展示路线，地域信息的工具', path: 'https://github.com/KyleBing/map'},
        ],
    },
    ...
    */
    ...
    },
    {
        ...
        isPublic: false,
        list: [
            {title: '嵌入式 FULL', isPublic: true, description: '嵌入式主机动环监测系统', path: 'http://121.36.2.95/em1000/full/#/'},
