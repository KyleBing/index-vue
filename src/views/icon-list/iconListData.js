export default [
    ...
    },
    {
        ...
        icons: [
            ...
            { noPadding: true ,  isNew: false,  isBgBlack: false,  pageLink: 'https://kylebing.cn/test/animate-canvas-lost/?isShowLine=1&titleFontSize=50&lineWidth=10&isShowTitle=0' ,icon: require('./icons/logo-web-canvas-lost.png') ,name: '迷离-线条' ,     } ,
            { noPadding: true ,  isNew: false,  isBgBlack: false,  pageLink: 'https://kylebing.cn/test/animate-canvas-lost' ,icon: require('./icons/logo-web-canvas-lost.png') ,name: '迷离' ,     } ,
