export default [
    {
        ...
        icons: [
            ...
            { noPadding: true ,  isNew: true,   isBgBlack: false,  pageLink: 'https://kylebing.cn/test/canvas-my-hole-life?v=1' , icon: require('./icons/logo-all-my-life.png') ,  name: '一生的时间' ,  },
        ]
    },
    {
        title: '工具',
        icons: [
            ...
            { noPadding: false , isNew: false, isBgBlack: false,  pageLink: 'https://kylebing.cn/qr?hash=two&from=kylebing.cn' ,  icon: require('./icons/logo-qr.png') ,                 name: '挪车提醒' ,     } ,
