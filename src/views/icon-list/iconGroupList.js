export default [
    ...
    },
    {
        ...
        icons: [
            ...
            { noPadding: false , isNew: false, isBgBlack: false,  pageLink: '../qr?hash=two' ,                        icon: require('./icons/logo-qr.png') ,                 name: '挪车提醒' ,     } ,
    ...
    },
    {
        title: '网易云 7日黑胶',
        icons: [
            { noPadding: true ,  isNew: true,   isBgBlack: false,  pageLink: 'https://music.163.com/prime/m/gift-receive?d=LicTw1fi166OdFT0EswA2A&p=8Hb1nvPLegqPZqAkk1X4xlKMM_KbjkbsHSvVTKQB0fSzhZGdb4zWtvqwkPSXqaPultJrult8QWEaFdu4mzcMcmXfc4AxH7mQAEAzduTiGB0&userid=79759260&app_version=8.9.73&dlt=0846' ,                     icon: require('./icons/logo-netease-music.png') ,name: '5月' ,     } ,
