export default [
    ...
    },
    {
        ...
        icons: [
            ...
            { noPadding: true, isNew: true, isBgBlack: false, pageLink: 'http://txti.es/',                                                    icon: require('./icons/logo-web-txti.png'),             name: '文字页面',     },
            { noPadding: true, isNew: true, isBgBlack: false, pageLink: 'https://pointerpointer.com/',                                        icon: require('./icons/logo-web-pointer.png'),          name: '点哪指哪',     },
            { noPadding: true, isNew: true, isBgBlack: false, pageLink: 'https://bruno-simon.com/',                                           icon: require('./icons/logo-web-racecar.png'),          name: '小赛车',      },
            { noPadding: true, isNew: true, isBgBlack: false, pageLink: 'https://greatestgifsofalltime.tumblr.com/',                          icon: require('./icons/logo-web-gif.gif'),              name: '唯美gif',    },
            { noPadding: true, isNew: true, isBgBlack: false, pageLink: 'https://www.makemepulse.com/',                                       icon: require('./icons/logo-web-amazing.png'),          name: '页面效果哇塞',   },
            { noPadding: true, isNew: true, isBgBlack: false, pageLink: 'https://chinesenewyear.net/',                                        icon: require('./icons/logo-web-chinese-new-year.png'), name: '中国年',      },
            { noPadding: true, isNew: true, isBgBlack: false, pageLink: 'https://cineshader.com/',                                            icon: require('./icons/logo-web-3d.png'),               name: '一个3D场景',   },
            { noPadding: true, isNew: true, isBgBlack: false, pageLink: 'https://theuselessweb.com/',                                         icon: require('./icons/logo-web-useless-website.png'),  name: '一堆无用站点',   },
            { noPadding: true, isNew: true, isBgBlack: false, pageLink: 'https://tympanus.net/Development/RainEffect/index.html#slide-4',     icon: require('./icons/logo-web-raining-outside.png'),  name: '窗外下雨了',    },
            { noPadding: true, isNew: true, isBgBlack: false, pageLink: 'https://www.noisli.com/',                                            icon: require('./icons/logo-web-noisli.png'),           name: '白嗓音',      },
        ]
    },
]
